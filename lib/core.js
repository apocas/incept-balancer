...
Core.prototype.start = function () {
  ...
  var server = net.createServer(function (clientStream) {
    ...
    //client->docker
    clientStream.pipe(self.through2docker(nodeStream, clientStream)).pipe(nodeStream);
...
Core.prototype.loadNode = function(nodeStream, clientStream, address) {
  ...
  //docker->client
  aux.pipe(self.through2client(nodeStream, clientStream, node), {end: false}).pipe(clientStream, {end: false});
};
...
Core.prototype.through2client = function(nodeStream, clientStream, node) {
  var self = this;
...
Core.prototype.through2docker = function(nodeStream, clientStream) {
  var self = this;
